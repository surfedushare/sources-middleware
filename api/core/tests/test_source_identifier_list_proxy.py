...
class TestSourceIdentifierListProxy(TestCase):
    ...
    def test_extract_identifiers(self):
        ...
        self.assertEqual(identifiers_1, ["b8c6aa6611e89f6f57545991e40f782e", "e78db0ee041b358c125c39abfa60da9b"])
        identifiers_2 = self.proxy.extract_identifiers(identifiers_response, "offset|2|2")
        self.assertEqual(identifiers_2, ["ed9d32d9000229b47d6acb8ac1dad9a2", "ed13bb012325d265868e5b8060db9713"])
